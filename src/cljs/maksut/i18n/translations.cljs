  ...
  {:rest-error        {:invoice-notfound                   {:fi "Laskua ei löydy"
   ...
   :invoice-not-found {:paid-oldsecret-header     {:fi "Linkki laskuun on vanhentunut"
                       ...
                       :decision-overdue-text-2   {:fi "Maksu perustuu opetus- ja kulttuuriministeriön voimassa olevaan asetukseen Opetushallituksen suoritteiden maksullisuudesta. Maksu on ulosottokelpoinen ilman tuomiota tai päätöstä (valtion maksuperustelaki (150/1992) 11§ 1.mom.)."
                                                   ...
                                                   :sv "Avgiften är baserad på undervisnings- och kulturministeriets gällande förordning om Utbildningsstyrelsens avgiftsbelagda prestationer. Avgiften får indrivas utan dom eller beslut (lag om grunderna för avgifter till staten (150/1992 11 § 1 mom.)."}
   ...
   :tutu-panel-ohje   {:kasittely-maksamatta-1 {:fi "Hakemuksesi on tallentunut. Hakemuksesi otetaan käsittelyyn, kun olet maksanut käsittelymaksun."
                       ...
                       :kasittely-maksamatta-2 {:fi "Jos olet täyttänyt tutkintojen tunnustamisen hakulomakkeen, sinun pitää myöhemmin maksaa erillinen päätösmaksu ennen kuin saat päätöksen. Kun olemme tehneet päätöksen hakemuksestasi, lähetämme sinulle päätösmaksun maksuohjeet sähköpostitse."
                       ...
                       :kasittely-maksettu-2   {:fi "Jos olet täyttänyt tutkintojen tunnustamisen hakulomakkeen, sinun pitää myöhemmin maksaa erillinen päätösmaksu. Kun olemme tehneet päätöksen hakemuksestasi, lähetämme sinulle sähköpostitse maksuohjeet päätösmaksusta. Lähetämme päätöksen vasta, kun olet maksanut päätösmaksun."
                       ...
                       :kasittely-maksettu-3   {:fi "Jos olet täyttänyt lopullisen päätöksen hakulomakkeen, sinulta ei peritä erillistä päätösmaksua."
                       ...
                       :paatos-maksettu        {:fi "Olet maksanut päätösmaksun. Olet saanut vahvistuksen maksun onnistumisesta sähköpostiisi. Olet saanut myös kuitin maksustasi erillisellä sähköpostilla. Lähetämme päätöksen sinulle mahdollisimman pian. Otathan huomioon, että tämä voi viedä jopa kolme työpäivää."
