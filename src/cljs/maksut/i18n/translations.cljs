...
(def local-translations
  {:rest-error     {:invoice-notfound                   {:fi "Laskua ei löydy"
   ...
   :tutu-panel-ohje {:kasittely-maksamatta {:fi "Hakemuksesi on tallentunut. Hakemuksesi otetaan käsittelyyn, kun olet maksanut käsittelymaksun. Huomaathan, että sinun tulee myöhemmin maksaa erillinen päätösmaksu ennen kuin saat päätöksen. Kun olemme tehneet päätöksen hakemuksestasi, lähetämme sinulle päätösmaksun maksuohjeet sähköpostitse."
                     ...
                     :paatos-maksettu      {:fi "Olet maksanut päätösmaksun. Olet saanut vahvistuksen maksun onnistumisesta sähköpostiisi. Lähetämme päätöksen sinulle mahdollisimman pian. Otathan huomioon, että tämä voi viedä jopa kolme työpäivää. Jos käytät yhteiskäyttöistä tietokonetta, muista tyhjentää selaimen välimuisti ja kirjautua ulos koneelta. Voit nyt sulkea tämän ikkunan."
                                            :en "You have paid the decision fee. A confirmation of the transaction has been sent to your email. We will send the decision to you as soon as possible. Please note that this might take up to three working days. If you are using a computer that is in common use, remember to empty the cache and log out from the computer. You can now close this window."
                                            :sv "Du har betalat beslutsavgiften. Du har fått en bekräftelse om betalningen till din e-post. Vi skickar beslutet till dig så snart som möjligt. Vänligen notera att detta kan ta upp till tre arbetsdagar. Om du använder en dator som är i gemensamt bruk, kom ihåg att tomma cacheminnen och logga ut ur datorn. Du kan nu stänga det här fönstret."}}
