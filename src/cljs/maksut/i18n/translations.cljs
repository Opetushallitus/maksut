...
(def local-translations
  {:rest-error        {:invoice-notfound                   {:fi "Laskua ei löydy"
   ...
   :tutu-panel-ohje   {:kasittely-maksamatta-1 {:fi "Hakemuksesi on tallentunut. Hakemuksesi otetaan käsittelyyn, kun olet maksanut käsittelymaksun."
                       ...
                       :kasittely-maksettu-1   {:fi "Olet maksanut käsittelymaksun. Olet saanut sähköpostiisi vahvistuksen maksusta. Hakemuksesi siirtyy seuraavaksi käsittelyyn."
                                                :en "You have paid the processing fee. A confirmation of the transaction has been sent to your email. Your application will now be taken into processing."
                                                :sv "Du har betalat behandlingsavgiften. Du har fått en bekräftelse om betalningen till din e-post. Din ansökan tas nu till behandling."}
