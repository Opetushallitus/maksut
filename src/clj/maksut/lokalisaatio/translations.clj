...
(def maksut-ui-local-translations
  {:Header.title                       {:fi "Maksutapahtumat"
                                        :en "Payments"
                                        :sv "Betalningar"}
   :Footer.title                       {:fi "Maksupalvelutarjoaja"
                                        :en "Payment Service Provider"
                                        :sv "Betaltjänstleverantör"}
   :Footer.provider                    {:fi "Maksunvälityspalvelun toteuttajana ja maksupalveluntarjoajana toimii Paytrail Oyj (2122839-7) yhteistyössä suomalaisten pankkien ja luottolaitosten kanssa. Paytrail Oyj näkyy maksun saajana tiliotteella tai korttilaskulla ja välittää maksun kauppiaalle. Paytrail Oyj:llä on maksulaitoksen toimilupa. Reklamaatiotapauksissa pyydämme ottamaan ensisijaisesti yhteyttä tuotteen toimittajaan."
   ...
   :Footer.address                     {:fi "Paytrail Oyj, y-tunnus: 2122839-7<br></br>Innova 2<br></br>Lutakonaukio 7<br></br>40100 Jyväskylä"
